 ...
 */
package teacheasy.mediahandler.image;
...
public class ImageObject {
	 ...
	 *            : group layout
	 */
	public ImageObject(Group nGroup, String imageName, double locationX, double locationY, double widthSize, double heightSize, double rotationDegree) {
		double imageWidth;
		double imageHeight;
